...
@SourceType(value = "SansanARP", label = "Sansan",uiConfig = "sansan-layout.json")
public class SansanConf extends AbstractArpConf<SansanConf> {
  private static final String ARP_FILENAME = "arp/implementation/sansan-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sansan.SansanDriver";
